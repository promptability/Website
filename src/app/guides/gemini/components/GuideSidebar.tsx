...
const navigationItems = [
  { id: 'core-principles', label: 'Core Principles', icon: BookOpen },
  { id: 'gemini-tricks', label: 'Gemini-Specific Tricks', icon: Sparkles },
  { id: 'comparison', label: 'Gemini vs GPT-4 vs Claude', icon: GitCompare },
  { id: 'use-cases', label: 'Best Use Cases', icon: Target },
  { id: 'pitfalls', label: 'Common Pitfalls', icon: AlertTriangle },
  { id: 'try-live', label: 'Try It Live', icon: TestTube },
  { id: 'download', label: 'Download PDF Guide', icon: Download },
];
